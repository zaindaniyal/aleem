import sqlite3
table_name = "maulawi_sher_ali"

def create_translation(line):
	parts = line.split("Footnote")
...
def insertTranslation(c, translation):
	c.execute("INSERT INTO " + table_name + " (chapter_id, verse_id, translation_text, footnotes_text) VALUES(?, ?, ?, ?)", ("", "", translation['t'], translation['f']))
...
translation = readTextSource("SherAliEngWHTMLTagsWFootnotes.txt")
